...
For step by step follow instruction from [Install Q CLI on Windows](https://builder.aws.com/content/2ySpxVfiIsy46THpP6YdlYgQZpD/how-to-install-amazon-q-cli-on-windows)
...
You can use Amazon Q Developer directly in your IDE for real-time code suggestions, inline completions, and integrated chat. 
For setup instructions see the [Amazon Q in IDE documentation](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/q-in-IDE.html).
